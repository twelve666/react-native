...
function TimeFormat(e) {
  ...
  return (
    <Text style={[styles.lbleft, styles.lbcolor]}>{'KOK体育-' + result}</Text>
  );
}
...
class News extends React.Component {
  ...
  componentDidMount() {
    ...
    this.navBarTabsHandler(); // 8.7 后可以删除
  ...
  render() {
    return (
      <View style={[styles.container, cstyle.flex1, styles.pageBorder]}>
                  ...
                  >
                    <View onLayout={this.viewLayoutHandler}>
                      ...
                      {this.state.initialEmpty ? (
                        ...
                        <>
                          {this.state.bannerFlag ? <Swiper 
                            data={this.state.dataSwiper}
                            gotoDetail={(data) => {
                              this.gotoDetail(data.articleId);
                            }}
                          /> : null}
                          {
                              ...
                              if (covers.length != 1 || covers[0].format == 1) {
                                return (
                                  <View key={item.id} >
                                    <CardView
                                      ...
                                      key={item.id}
                                    >
                                      <DetailOnPress returnParam={item.id} onPress={this.gotoDetail}>
                                ...
                                return (
                                  <View key={item.id}>
                                    ...
                                    >
                                      <DetailOnPress returnParam={item.id} onPress={this.gotoDetail}>
                                        <View style={[styles.listitem, styles.lrpart]}>
                                          ...
                                          <View style={styles.right}>
                                            <Image style={styles.imgStyle} source={{ uri: covers[0].coverNrl }} />
                                          </View>
                                        </View>
                                      </DetailOnPress>
                                    </CardView>
                      ...
                      <Text style={styles.loadmore}>{!this.state.initialEmpty && this.state.canShowNoMoreData ? '' : '没有更多数据了...'}</Text>
        ...
        {!this.state.loading && this.state.timeout && <NetWorkError style={styles.networkErrStyle} onPress={()=>{this.onFresh();}} />}
        <BackTop
