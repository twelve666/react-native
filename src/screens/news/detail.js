...
function TimeFormat(e) {
  ...
  return <Text style={styles.tbottomitem}>{'KOK体育-' + result}</Text>;
}
    ...
    return (
      <View style={styles.pageBorder}>
        ...
        {this.state.initialEmpty ? (
          ...
          <>
            <ScrollView style={styles.contaienr} showsVerticalScrollIndicator={this.showsVerticalScrollIndicator}
              //  刷新
              refreshControl={
                <RefreshControl
